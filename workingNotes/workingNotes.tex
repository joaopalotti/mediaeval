...
%moves all documents from the original list (Flickr ranking) to a re-ranked list.
...
This research was funded by the Austrian Science Fund (FWF) project number I1094-N23 (MUCKE) \todo{What else? Admire}.
